...
vec3 HColor( float t, vec3 N )
{
  float ct = t;
  t = max(0.0, min(t, 0.5));
  vec3 pc = texture2D(Texture2, vec2(t, 0)).rgb;
  float c = abs(dot(N, vec3(0, 1, 0)));
  c = 1 - pow(1 - c, 10);
  if (ct > 0.7)
    return mix(pc, vec3(1, 1, 1), c);
  else
    return pc;
  /*
  vec3 cols[] =
    {
      {0.2, 0.3, 0.1}, {0.15, 0.25, 0.1}, {0.15, 0.2, 0.1}, {0.1, 0.2, 0.1},
      {0.15, 0.15, 0.1}, {0.2, 0.1, 0.1}, {0.2, 0.15, 0.1}, {0.25, 0.15, 0.1},
      {0.27, 0.17, 0.1}, {0.25, 0.12, 0.1}, {0.25, 0.17, 0.1}, {0.21, 0.18, 0.1},
      {0.27, 0.17, 0.1}, {0.25, 0.12, 0.1}, {0.25, 0.17, 0.1}, {0.21, 0.18, 0.1},
      {0.27, 0.17, 0.1}, {0.25, 0.12, 0.1}, {0.25, 0.17, 0.1}, {0.21, 0.18, 0.1},
      {0.27, 0.17, 0.1}, {0.25, 0.12, 0.1}, {0.25, 0.17, 0.1}, {0.21, 0.18, 0.1},
      {0.27, 0.17, 0.1}, {0.25, 0.12, 0.1}, {0.25, 0.17, 0.1}, {0.21, 0.18, 0.1},
      ...
      {0.27, 0.17, 0.1}, {0.25, 0.12, 0.1}, {0.25, 0.17, 0.1}, {0.21, 0.18, 0.1},
      {0.27, 0.17, 0.1}, {0.25, 0.12, 0.1}, {0.25, 0.17, 0.1}, {0.21, 0.18, 0.1},
      {0.36, 0.2, 0.1}, {0.35, 0.2, 0.1}, {0.34, 0.2, 0.1}, {0.33, 0.2, 0.1},
      {0.33, 0.2, 0.1}, {0.33, 0.2, 0.1}, {0.33, 0.2, 0.1}, {0.33, 0.2, 0.1},
      {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1},
      {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.4, 0.3, 0.1},
      {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1},
      {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1},
      {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1},
      {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1}, {0.3, 0.2, 0.1},
      ...
      {0.9, 0.9, 0.9}, {0.9, 0.9, 0.9}, {0.9, 0.9, 0.9}, {0.9, 0.9, 0.9},
      {0.9, 0.9, 0.9}, {0.9, 0.9, 0.9}, {0.9, 0.9, 0.9}, {0.9, 0.9, 0.9},
      {0.955, 0.955, 0.966}, {0.957, 0.957, 0.967}, {0.957, 0.957, 0.968}, {0.958, 0.958, 0.969},
      {0.955, 0.955, 0.966}, {0.957, 0.957, 0.967}, {0.957, 0.957, 0.960}, {0.958, 0.958, 0.961},
      {0.955, 0.955, 0.962}, {0.957, 0.957, 0.963}, {0.957, 0.957, 0.964}, {0.958, 0.958, 0.965},
      {0.955, 0.955, 0.966}, {0.957, 0.957, 0.967}, {0.957, 0.957, 0.968}, {0.958, 0.958, 0.969},
      {0.96, 0.96, 0.97}, {0.96, 0.96, 0.97}, {0.96, 0.96, 0.97}, {0.97, 0.97, 0.98},
      {0.98, 0.98, 0.99}, {0.98, 0.98, 0.99}, {0.98, 0.99, 0.99}, {0.98, 0.98, 0.99},
...
void main( void )
{
  ...
  vec3 c = HColor(Pos.y + 0.15 * Pos.y * (fBm(vec3(Pos.x * 90, Pos.y, Pos.z * 90))), N);
